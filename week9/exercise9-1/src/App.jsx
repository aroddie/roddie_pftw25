      ...
      <form onSubmit={handleSubmit(getFormData)}>
        <fieldset>
          ...
          <div className="form-group">
            ...
            <input type="text" defaultValue="" id="firstName" {...register("firstName")}/>
        </div>
        <div className="form-group">
          <label htmlFor="lastName">Last Name</label>
          <input type="text" defaultValue="" id="lastName"{...register("lastName")} />
        </div>
        <div className="form-group">
          <label htmlFor="streetAddress"> Street Address</label>
          <input type="text" defaultValue="" id="streetAddress" {...register("streetAddress")} />
        </div>
        <div className="form-group">
